<<<<<<< HEAD:src/view/sceneControllers/UtilitiesPaneController.java
/*
...
public class UtilitiesPaneController extends BaseView implements Initializable  {
   ...
   /* private AddUtility AddUtility;
    ...
    void insertUtilityBtnClicked(ActionEvent event) throws IOException {
      ...
      borderPane.setRight(FXMLLoader.load(getClass().getResource("/view/scene/AddUtility.fxml")));
...
>>>>>>> 75c338deaea6b1b1500fb9430a85d86a0134f511:src/controller/UtilitiesPaneController.java
